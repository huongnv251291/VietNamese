...
import com.tohsoftkeyboard.languagepack.vietnamese.R;
...
//            @Override
//            public void run() {
//                TypedArray a = MainActivity.this.getResources().obtainTypedArray(R.array.vn_dict_array);
//                try {
//                   int[] resId = new int[a.length()];
